...
#Notes: This script iterates through a directory containing the directories of 1000 scaffold.bam files, merges each group together, and moves it to a new directory.
